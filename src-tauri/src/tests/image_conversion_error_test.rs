...
fn test_image_conversion_error_image_error_should_display_correct_error_message() {
    let image_error = ImageError::Decoding(DecodingError::new(ImageFormatHint::Unknown, "ImageEnd"));
    let actual_error_message = ImageConversionError::ImageError(image_error).to_string();
    let expected_error_message = "Failed to decode image: Format error decoding `Unknown`: ImageEnd";
...
fn test_image_conversion_error_webp_encoding_error_should_display_correct_error_message() {
    ...
    let actual_error_message = ImageConversionError::WebPEncodingError(WebPEncodingErrorWrapper(webp_encoding_error)).to_string();
...
fn test_image_conversion_error_failed_to_get_parent_directory_error_should_display_correct_error_message() {
    let actual_error_message = ImageConversionError::FailedToGetParentDirectoryError("Failed to get parent directory".to_string()).to_string();
...
fn test_image_conversion_error_failed_to_get_file_name_error_should_display_correct_error_message() {
    let actual_error_message = ImageConversionError::FailedToGetFileNameError("Failed to get file name".to_string()).to_string();
