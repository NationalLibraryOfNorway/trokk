...
export default function StatusOverlay({status, size = 'medium', customText}: StatusOverlayProps) {
    ...
    return (
        <div className={`bg-accent/60 backdrop-blur-sm absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg flex items-center gap-2 z-[5] ${sizeClasses[size]}`}>
            <Icon
                size={iconSizes[size]}
