            ...
            {isLoading ? (
                ...
                <div className="flex justify-center">
                    ...
                    <div className="px-6" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div
                            className='relative group mt-4 mb-10 flex items-center justify-center
                                    max-w-[calc(100vw-400px)] max-h-[calc(100vh-250px)]
                                    w-fit h-fit'
                        >
                            <img
                                ...
                                className={cn(
                                    'border-4 block max-w-full max-h-full object-contain',
                                    isChecked ? 'border-amber-400' : 'border-gray-300'
                                )}
                            />
                            <StatusOverlay status={imageStatus} size="large"/>
                            <div
                                className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-row gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button
                                    onClick={(e) => {
                                        e.stopPropagation();
                                ...
                                >
                                    ...
                                    <span
                                        className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-1 bg-gray-900 text-white text-sm rounded whitespace-nowrap opacity-0 group-hover/btn:opacity-100 transition-opacity pointer-events-none">
                                            Roter mot klokken
                                        </span>
                                </button>
                                <button
